...
export const getAwsCredentials = (token, provider) => (
  new Promise((resolve, reject) => {
    console.log('getAwsCredentials: Promise')
    let providerKey = '';
    switch (provider) {
      case 'user_pool':
    ...
    console.log(providerKey, ' and identityPool: ', Config.awsCognitoIdentityPoolId)
...
export const authUser = async () => {
  ...
  if (store.getters.isAuthenticated) {
    ...
    await getAwsCredentials(store.getters.idToken, 'user_pool')
